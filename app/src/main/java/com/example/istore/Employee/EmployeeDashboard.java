...
import com.example.istore.Manager.AllProducts;
        ...
        for (int i = 0; i < mainGrid.getChildCount(); i++) {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        Intent p = new Intent(EmployeeDashboard.this, AllProducts.class);
                        startActivity(p);
                        Log.i("message:", "addNewProd success");
                    } else if (finalI == 3)//open Ventor_return activity
                    {
                        Intent p = new Intent(EmployeeDashboard.this, ViewOrders.class);
                        startActivity(p);
                        Log.i("message:", "addNewProd success");
                    } else {
